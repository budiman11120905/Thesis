...
if (session_is_registered('id'))
{
	...
	<tr> 
	  ...
	  <td width="87%" bgcolor="#5686c6" ><div align="center"><strong><font face="verdana" size="2" color="#FFFFFF">Data Driver </font></strong></div></td>
	...
	<tr> 
		...
		<strong>Jumlah Driver : <? echo $jumlah; ?></strong></font></div></td>
