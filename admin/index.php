...
if (isset($_POST['admin']))
{
	...
	$login=mysql_db_query($db,"select * from admin1 where username='$userid' and password='$password'",$koneksi);
...
<body><p>&nbsp;</p>
<p>&nbsp;</p>
<table width="19%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#99CC99" bgcolor="#FFFFFF">
<tr> 
