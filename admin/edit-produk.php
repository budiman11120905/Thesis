...
?>
	...
	<tr> 
		...
		<td width="96%" bgcolor="#5686c6" ><div align="center"><strong><font face="verdana" size="2" color="#FFFFFF">Data Pengiriman </font></strong></div></td>
				...
				<tr>
				  ...
				  <td width="10%" bgcolor="#CCCCCC"><div align="center"><b><font color="#666666" size="2" face="Arial, Helvetica, sans-serif">EDIT</font></b></div>
					...
					<tr>
						...
						<td align="center">
							<a href=home.php?page=14&id=<? echo $row[0]; ?> style='text-decoration:none' title="Update terakhir : <? echo $row['tgl'];?>">
	...
	<tr> 
		...
		<td bgcolor="#5686c6" ><div align="center"><strong><font face="verdana" size="2" color="#FFFFFF">Jumlah Pengiriman : <b><? echo $jumlah; ?></font></strong></div></td>
