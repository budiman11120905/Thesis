...
if (session_is_registered('id'))
{
	...
	<tr> 
		...
		<td width="92%" bgcolor="#5686c6" ><div align="center"><strong><font face="verdana" size="2" color="#FFFFFF">Data Transaksi</font></strong></div></td>
	...
	<tr>
		...
		<table width="547" align="center">
			...
			<table width="115%" border="0" align="center" cellpadding="0">
				...
				<tr>
					...
					<td align="center">
						...
						<font face="verdana" size="-4" color="#666666"><br />Autor: <? echo $nama; ?> </font>
					</td>
			...
			<tr> 
				...
				<td bgcolor="#5686c6" ><div align="center"><strong><font color="#FFFFFF" size="2" face="verdana">Jumlah Transaksi : <b><? echo $jumlah; ?></b></font></strong></div></td>
